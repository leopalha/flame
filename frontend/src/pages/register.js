              ...
              <>
                <form onSubmit={(e) => { e.preventDefault(); registerForm.handleSubmit(handleRegister); }}>
                  ...
                  <div className="mb-4">
                    ...
                    {registerForm.isFieldInvalid('nome') && (
                      <p className="mt-2 text-sm text-orange-400">{registerForm.errors.nome}</p>
                    )}
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    {registerForm.isFieldInvalid('email') && (
                      <p className="mt-2 text-sm text-orange-400">{registerForm.errors.email}</p>
                    )}
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    {registerForm.isFieldInvalid('celular') && (
                      <p className="mt-2 text-sm text-orange-400">{registerForm.errors.celular}</p>
                    )}
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    {registerForm.isFieldInvalid('password') && (
                      <p className="mt-2 text-sm text-orange-400">{registerForm.errors.password}</p>
                    )}
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    {registerForm.isFieldInvalid('confirmPassword') && (
                      <p className="mt-2 text-sm text-orange-400">{registerForm.errors.confirmPassword}</p>
                    )}
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    {registerForm.isFieldInvalid('acceptTerms') && (
                      <p className="mt-2 text-sm text-orange-400">{registerForm.errors.acceptTerms}</p>
                    )}
                  </div>
