  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center px-4">
        ...
        <div className="absolute top-0 left-0 w-96 h-96 rounded-full opacity-5" style={{ background: palette.primary, filter: 'blur(80px)' }}></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full opacity-5" style={{ background: palette.secondary, filter: 'blur(80px)' }}></div>
        ...
        >
          ...
          <div className="text-center mb-8">
            <motion.div
              ...
              style={{ background: `${palette.primary}20`, borderColor: palette.primary, borderWidth: '2px' }}
            >
              <LogIn className="w-8 h-8" style={{ color: palette.primary }} />
            </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.button
                ...
                style={{
                  background: loading ? palette.secondary : palette.primary,
